...
public class Outputt extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction (
                ...
                "Outputt Page", // TODO: Define a title for the content shown.
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ProsesTahapan tab1 = new ProsesTahapan ();
                    return tab1;
                case 1:
                    graphview tab2 = new graphview ();
                    return tab2;
                case 2:
                    tab3 tab3 = new tab3 ();
                    return tab3;
